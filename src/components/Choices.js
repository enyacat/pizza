  ...
  const handleChange = (e) => {
    ...
    if (openFood.section === 'Traditional-pizza') {
      if (choiceValue === 'Medium') {
        dispatch(setOpenFood({ ...openFood, price: 13, choice: 'Medium' }))
      } else if (choiceValue === 'Large') {
        dispatch(setOpenFood({ ...openFood, price: 15, choice: 'Large' }))
      } else if (choiceValue === 'Family') {
        dispatch(setOpenFood({ ...openFood, price: 20, choice: 'Family' }))
      }
    } else if (openFood.section === 'Gourmet-pizza') {
      if (choiceValue === 'Medium') {
        dispatch(setOpenFood({ ...openFood, price: 15, choice: 'Medium' }))
      } else if (choiceValue === 'Large') {
        dispatch(setOpenFood({ ...openFood, price: 17, choice: 'Large' }))
      } else if (choiceValue === 'Family') {
        dispatch(setOpenFood({ ...openFood, price: 23, choice: 'Family' }))
      }
    } else if (openFood.section === 'Seafood-pizza') {
      if (choiceValue === 'Medium') {
        dispatch(setOpenFood({ ...openFood, price: 16, choice: 'Medium' }))
      } else if (choiceValue === 'Large') {
        dispatch(setOpenFood({ ...openFood, price: 18, choice: 'Large' }))
      } else if (choiceValue === 'Family') {
        dispatch(setOpenFood({ ...openFood, price: 24, choice: 'Family' }))
      }
    } else if (openFood.section === 'Desserts') {
      if (choiceValue === 'Large') {
        dispatch(setOpenFood({ ...openFood, price: 14, choice: 'Large' }))
      } else if (choiceValue === 'Family') {
        dispatch(setOpenFood({ ...openFood, price: 20, choice: 'Family' }))
      }
    } else {
